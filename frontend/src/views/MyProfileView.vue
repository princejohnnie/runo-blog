...
<template>
  ...
  <section class="myArticles">
    <div class="myArticles__inner">
      <h3 class="section__heading">My Articles</h3>
      <div class="myArticles__articles">
        <RouterLink to="/create-article" class="createArticle">
          <div class="createArticle__inner">
            ...
            <span class="createArticle__text"> Add new article </span>
          </div>
        </RouterLink>

        <ArticleCardBig
          v-for="(userArticle, index) in articles"
          :key="index"
          :article="userArticle"
          :showCreateIcon="true"
          class="createArticle__article--active"
        />
      </div>
    </div>
  </section>
