  ...
  <section class="subscription">
    <div class="subscription__inner" v-if="userStore.user.isPremium === false">
      ...
      <div class="subscription__active">
        <p class="subscription__active-text">No active subscription.</p>
        <button class="subscription__premiumButton" @click.prevent="openSubscribeModal()">
          Go Premium
        </button>
      </div>
    </div>
    ...
    <div class="subscription__inner" v-else>
      ...
      <div class="subscription__active">
        <div class="subscription__activeInfo">
          <h3 class="subscription__ActiveType">{{ subscriptionStatus }} Premium</h3>
          ...
          <p class="subscription__cancelLink" @click.prevent="openCancelSubscriptionModal()">
            Cancel subscription
          </p>
        </div>
